        ...
        success: function(response){
            ...
            data.forEach(element => {
                ...
                analysisLink.addEventListener("click", function(event) {
                    ...
                    if (!document.getElementById(`patient-${element.id}`).classList.contains("selected")){
                        document.getElementById(`patient-${element.id}`).classList.add("selected")
                    }
                ...
                admin.addEventListener("click", function(event) {
                    ...
                    if (document.getElementById(`patient-${element.id}`).classList.contains("selected")){
                        document.getElementById(`patient-${element.id}`).classList.remove("selected")
                    }
                    if (document.getElementById(`dropdown-${element.id}`).classList.contains("not-visible")){
                ...
                analysisLinkTablet.addEventListener("click", function(event) {
                    ...
                    if (!chatTabletBox.classList.contains("not-visible")){
                        chatTabletBox.classList.add("not-visible")
                    }
                    ...
                    if (!document.getElementById(`patient-${element.id}-t`).classList.contains("selected")){
                        document.getElementById(`patient-${element.id}-t`).classList.add("selected")
                    }
                ...
                chatLinkTablet.addEventListener("click", function(event) {
                    ...
                    if (chatTabletBox.classList.contains("not-visible")){
                        chatTabletBox.classList.remove("not-visible")
                    }
                ...
                adminTablet.addEventListener("click", function(event) {
                    ...
                    if (document.getElementById(`patient-${element.id}-t`).classList.contains("selected")){
                        document.getElementById(`patient-${element.id}-t`).classList.remove("selected")
                    }
                    if (document.getElementById(`dropdown-${element.id}-t`).classList.contains("not-visible")){
                ...
                analysisLinkMobile.addEventListener("click", function(event) {
                    ...
                    if (!chatMobileBox.classList.contains("not-visible")){
                        chatMobileBox.classList.add("not-visible")
                    }
                    ...
                    if (!document.getElementById(`patient-${element.id}-m`).classList.contains("selected")){
                        document.getElementById(`patient-${element.id}-m`).classList.add("selected")
                    }
                ...
                chatLinkMobile.addEventListener("click", function(event) {
                    ...
                    if (chatMobileBox.classList.contains("not-visible")){
                        chatMobileBox.classList.remove("not-visible")
                    }
